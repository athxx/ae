...
pub static DATAMODEL_STR: &'static str = include_str!("/home/dev/ae/prisma/schema.prisma");
static DATABASE_STR: &'static str = "sqlite";
use ::prisma_client_rust::migrations::include_dir;
pub static MIGRATIONS_DIR: &::prisma_client_rust::migrations::include_dir::Dir = &::prisma_client_rust::migrations::include_dir::include_dir!("/home/dev/ae/prisma/migrations");
...
pub mod user {
    ...
    pub mod display_name {
        ...
        ::prisma_client_rust::scalar_where_param_fns!(_prisma::read_filters::StringFilter, DisplayName, {
            fn in_vec(_: Vec<String>) -> InVec;
            fn not_in_vec(_: Vec<String>) -> NotInVec;
            fn lt(_: String) -> Lt;
            fn lte(_: String) -> Lte;
            ...
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
                let (args, selections) = match self {
                    ...
                    Self::Include(args, selections) => (args.to_graphql().0, {
                        let mut nested_selections = <post::Types as ::prisma_client_rust::ModelTypes>::scalar_selections();
                        nested_selections.extend(selections.into_iter().map(|s| s.to_selection()));
                        nested_selections
                    }),
                    Self::Fetch(args) => (args.to_graphql().0, <post::Types as ::prisma_client_rust::ModelTypes>::scalar_selections()),
                };
    ...
    pub fn create_unchecked(display_name: String, _params: Vec<SetParam>) -> (String, Vec<SetParam>) {
        (display_name, _params)
    }
    #[macro_export]
    ...
    impl Data {
        pub fn posts(&self) -> Result<&Vec<super::post::Data>, ::prisma_client_rust::RelationNotFetchedError> {
            self.posts.as_ref().ok_or(::prisma_client_rust::RelationNotFetchedError::new(stringify!(posts)))
        }
    }
    #[derive(Clone)]
    pub enum WithParam {
        ...
        fn into(self) -> ::prisma_client_rust::Selection {
            match self {
                Self::Posts(args) => {
                    ...
                    nested_selections.extend(<super::post::Types as ::prisma_client_rust::ModelTypes>::scalar_selections());
                    ::prisma_client_rust::Selection::new(posts::NAME, None, arguments, nested_selections)
                }
            }
        }
    }
    ...
    impl From<SetParam> for (String, ::prisma_client_rust::PrismaValue) {
        fn from(param: SetParam) -> Self {
            match param {
                ...
                SetParam::SetDisplayName(value) => (display_name::NAME.to_string(), ::prisma_client_rust::PrismaValue::String(value)),
    ...
    impl Into<(String, ::prisma_client_rust::PrismaValue)> for OrderByParam {
        fn into(self) -> (String, ::prisma_client_rust::PrismaValue) {
            match self {
                ...
                Self::DisplayName(direction) => (display_name::NAME.to_string(), ::prisma_client_rust::PrismaValue::String(direction.to_string())),
            }
        }
    }
    #[derive(Clone)]
    ...
    impl ::prisma_client_rust::ModelTypes for Types {
        ...
        fn scalar_selections() -> Vec<::prisma_client_rust::Selection> {
            vec![::prisma_client_rust::sel(id::NAME), ::prisma_client_rust::sel(display_name::NAME)]
        }
    }
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create_unchecked(self, display_name: String, mut _params: Vec<UncheckedSetParam>) -> Create<'a> {
            _params.extend([display_name::set(display_name)]);
        ...
        pub fn upsert(self, _where: UniqueWhereParam, (display_name, mut _params): (String, Vec<SetParam>), _update: Vec<SetParam>) -> Upsert<'a> {
            _params.extend([display_name::set(display_name)]);
...
pub mod post {
    ...
    pub mod content {
        ...
        ::prisma_client_rust::scalar_where_param_fns!(_prisma::read_filters::StringFilter, Content, {
            fn in_vec(_: Vec<String>) -> InVec;
            fn not_in_vec(_: Vec<String>) -> NotInVec;
            fn lt(_: String) -> Lt;
            fn lte(_: String) -> Lte;
    ...
    pub mod user_id {
        ...
        ::prisma_client_rust::scalar_where_param_fns!(_prisma::read_filters::StringFilter, UserId, {
            fn in_vec(_: Vec<String>) -> InVec;
            fn not_in_vec(_: Vec<String>) -> NotInVec;
            fn lt(_: String) -> Lt;
            fn lte(_: String) -> Lte;
    ...
    pub fn create(content: String, user: super::user::UniqueWhereParam, _params: Vec<SetParam>) -> (String, super::user::UniqueWhereParam, Vec<SetParam>) {
        (content, user, _params)
    }
    pub fn create_unchecked(content: String, user_id: String, _params: Vec<SetParam>) -> (String, String, Vec<SetParam>) {
    ...
    impl From<SetParam> for (String, ::prisma_client_rust::PrismaValue) {
        fn from(param: SetParam) -> Self {
            match param {
                SetParam::SetId(value) => (id::NAME.to_string(), ::prisma_client_rust::PrismaValue::String(value)),
                SetParam::SetContent(value) => (content::NAME.to_string(), ::prisma_client_rust::PrismaValue::String(value)),
                ...
                SetParam::SetUserId(value) => (user_id::NAME.to_string(), ::prisma_client_rust::PrismaValue::String(value)),
            }
        }
    }
    #[derive(Clone)]
    ...
    impl Into<(String, ::prisma_client_rust::PrismaValue)> for OrderByParam {
        fn into(self) -> (String, ::prisma_client_rust::PrismaValue) {
            match self {
                Self::Id(direction) => (id::NAME.to_string(), ::prisma_client_rust::PrismaValue::String(direction.to_string())),
                Self::Content(direction) => (content::NAME.to_string(), ::prisma_client_rust::PrismaValue::String(direction.to_string())),
                Self::UserId(direction) => (user_id::NAME.to_string(), ::prisma_client_rust::PrismaValue::String(direction.to_string())),
            }
        }
    }
    #[derive(Clone)]
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create(self, content: String, user: super::user::UniqueWhereParam, mut _params: Vec<SetParam>) -> Create<'a> {
            _params.extend([content::set(content), user::connect(user)]);
            Create::new(self.client, _params)
        }
        pub fn create_unchecked(self, content: String, user_id: String, mut _params: Vec<UncheckedSetParam>) -> Create<'a> {
        ...
        pub fn upsert(self, _where: UniqueWhereParam, (content, user, mut _params): (String, super::user::UniqueWhereParam, Vec<SetParam>), _update: Vec<SetParam>) -> Upsert<'a> {
            _params.extend([content::set(content), user::connect(user)]);
            Upsert::new(self.client, _where.into(), _params, _update)
        }
        pub fn delete(self, _where: UniqueWhereParam) -> Delete<'a> {
